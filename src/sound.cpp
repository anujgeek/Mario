  ...
  channels() 
{
  ...
  music = Mix_LoadMUS("sound/smb_stage_clear.wav");
  ...
  startMusic();
  sounds.push_back(Mix_LoadWAV("sound/smb_jump-small.wav"));
  sounds.push_back(Mix_LoadWAV("sound/smb_stomp.wav"));
  sounds.push_back(Mix_LoadWAV("sound/smb_coin.wav"));
  sounds.push_back(Mix_LoadWAV("sound/smb_mariodie.wav"));
